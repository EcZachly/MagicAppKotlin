...
interface PagerLoop{
    fun initializeLoopingAdapter (context: Context, viewPager: ViewPager, pagerAdapter: FragmentStatePagerAdapter, adapterTabs: RecyclerTabLayout, card: Card){

        viewPager.adapter = pagerAdapter

        adapterTabs.setUpWithAdapter(DetailPrintThumbAdapter(context, viewPager, card))
